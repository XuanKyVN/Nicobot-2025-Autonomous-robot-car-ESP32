...
model = YOLO(r"C:\Users\Admin\PythonLession\Flask_SocketIO\RobotSocketIO_thread\RobotThreadGood\model\yolo11n.pt")
...
def background_thread(event): #   Logitect Camera
...
def background_thread1(event):  # Intel Realsens Camera
