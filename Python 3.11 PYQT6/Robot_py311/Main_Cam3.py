...
class VideoThread(QThread):
    ...
    def __init__(self, index):
        ...
        self.pretrain_path = "model\yolo11n.pt"


    def run(self):
        self.model1 = YOLO(r"model\yolo11n.pt")   # Use for Normal Camera
        self.model = YOLO(self.pretrain_path)  # Use for Intel Realsens Cam
            ...
            if (self._run_flag_fwd):
                ...
                try:
                    while self._run_flag_fwd:
                        ...
                        # ---------------YOLO-------------------
                        results = self.model1.predict(color_image, device=[0])  # detect all object
    ...
    def video_receivedata(self, data):
        ...
        if ("set_video_path" in data.keys()):
            ...
            self.pretrain_path = data["set_pretrain"]
